...
#define return_if_fail(expr) if (!(expr)) {ortp_error("%s:%i- assertion"#expr "failed\n",__FILE__,__LINE__); return;}
#define return_val_if_fail(expr,ret) if (!(expr)) {ortp_error("%s:%i- assertion" #expr "failed\n",__FILE__,__LINE__); return (ret);}
